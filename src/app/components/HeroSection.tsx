...
function HeroSection() {
  ...
  <Spotlight
      ...
      <div className='p-4 relative z-10 w-full text-center'>
        ...
        <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quidem iure soluta dolorem tempora non excepturi animi quis sequi asperiores quod quisquam commodi, numquam dolorum dolor, placeat temporibus qui tempore?</p>
        <div className='mt-4 '>
          <Link href={'/courses'}>
              <Button
